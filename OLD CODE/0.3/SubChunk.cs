...
public class SubChunk : MonoBehaviour
{
    ...
    public void SetMeshCollider(MeshCollider mc)
    {
        this.mc = mc;
    }
    ...
    public void Generate()
    {
        ...
        for (int x = 0; x <= sizeX; x++)
        {
            ...
            {
                float perlin = Mathf.PerlinNoise((position.x + x + offset) * 0.05f, (position.z + z + offset) * 0.05f) * 4f;
...
public class Cube
{
    ...
    {
        return Mathf.Clamp01(-n0.weight * (1f / (n1.weight - n0.weight)));
    }
}
